...
export const S: Record<string, CSSProperties> = {
  ...
  bar: { display: "flex", alignItems: "center", gap: 12, padding: "6px 14px",
    borderBottom: "1px solid #2a2a34" },
  graphTools: { display: "flex", alignItems: "center", gap: 5, padding: "4px 12px",
    borderBottom: "1px solid #202a25", background: "#0c110f", overflowX: "auto" },
  graphSearch: { flex: "1 1 240px", minWidth: 180, display: "flex", alignItems: "center",
    gap: 6, height: 28, padding: "0 8px", border: "1px solid #29352f", background: "#080c0a" },
  graphSearchInput: { flex: 1, minWidth: 0, border: 0, outline: 0, background: "transparent",
    color: "#dce5e0", fontSize: 11 },
  graphControl: { height: 28, padding: "0 8px", border: "1px solid #29352f",
    borderRadius: 3, background: "#111713", color: "#9eaaa4", fontSize: 9,
    whiteSpace: "nowrap" },
  ...
  credentialOverlayActive: { borderColor: "#7b6734", color: "#e3b341",
    background: "#1c1709" },
  tabs: { display: "flex", flexShrink: 0, gap: 2, background: "#101512", padding: 2,
    borderRadius: 4, border: "1px solid #29352f" },
  ...
  fileDropOverlay: { position: "absolute", inset: 8, zIndex: 4, display: "grid",
    ...
    pointerEvents: "none" },
  dropFileError: { display: "flex", alignItems: "center", gap: 10,
    padding: "8px 14px", borderBottom: "1px solid #4c2626", background: "#1f1414",
    color: "#f1aaa3", fontSize: 12 },
  fileDropBusyOverlay: { position: "absolute", inset: 8, zIndex: 4, display: "grid",
    placeItems: "center", border: "2px dashed #6aa9ff", borderRadius: 8,
    background: "rgba(11,19,26,.72)", color: "#6aa9ff", fontSize: 13, fontWeight: 600,
  ...
  nodeNotesHead: { display: "flex", alignItems: "center", justifyContent: "space-between" },
  nodeNotesLabel: { color: "#9a9aa6", fontSize: 10, fontWeight: 600,
    letterSpacing: ".06em", textTransform: "uppercase" },
  nodeNotesSave: { border: "1px solid #454552", borderRadius: 6, padding: "4px 9px",
    background: "#22222b", color: "#e7e7ee", fontSize: 10, fontWeight: 600, cursor: "pointer" },
  nodeNotesArea: { width: "100%", minHeight: 72, padding: "8px 10px", borderRadius: 6,
    border: "1px solid #2a2a34", background: "#0e0e12", color: "#e7e7ee",
    fontSize: 12, lineHeight: 1.5, resize: "vertical" },
  credentialDetail: { marginTop: 14, border: "1px solid #4c4428", background: "#111006" },
  credentialDetailHead: { display: "flex", alignItems: "center", justifyContent: "space-between",
    gap: 12, padding: "11px 12px", borderBottom: "1px solid #332f1f" },
  credentialFacts: { display: "grid", gap: 0, margin: 0, padding: "4px 12px" },
  credentialSecret: { display: "block", margin: "6px 12px 10px", padding: 10,
    border: "1px solid #3a3420", background: "#080803", color: "#f0d979",
    font: "10px/1.5 ui-monospace,monospace", overflowWrap: "anywhere", whiteSpace: "pre-wrap" },
  netexecNodeResult: { marginTop: 14, border: "1px solid #31513e", background: "#0b120e" },
  netexecNodeResultHead: { display: "flex", alignItems: "center", justifyContent: "space-between",
    padding: "10px 12px", borderBottom: "1px solid #26392f", color: "#59f59a",
    font: "9px ui-monospace,monospace" },
  netexecTree: { borderTop: "1px solid #26392f" },
  ...
  quickMenu: { position: "fixed", width: 236, margin: 0, padding: 6,
    border: "1px solid #35453d", borderRadius: 6, background: "#0d1210",
    color: "#d8e2dd", boxShadow: "0 18px 48px rgba(0,0,0,.62)" },
  quickMenuHead: { display: "grid", gap: 3, minWidth: 0, padding: "8px 9px 10px" },
  quickMenuTitle: { overflow: "hidden", color: "#eff7f2", fontSize: 12,
    textOverflow: "ellipsis", whiteSpace: "nowrap" },
  quickMenuStatus: { color: "#6f8379", font: "9px ui-monospace,monospace",
    letterSpacing: 1, textTransform: "uppercase" },
  quickMenuGroup: { display: "grid", gap: 2, padding: "5px 0",
    borderTop: "1px solid #202d27" },
  quickMenuItem: { display: "grid", gridTemplateColumns: "22px minmax(0,1fr)",
    alignItems: "center", width: "100%", minHeight: 32, padding: "0 9px", border: 0,
    borderRadius: 3, background: "transparent", color: "#b9c8c0", textAlign: "left",
    cursor: "pointer", fontSize: 11 },
  quickMenuIcon: { color: "#64d994", font: "12px ui-monospace,monospace" },
  quickMenuDanger: { color: "#ff8a8a" },
  ...
  requestTechniqueActions: { alignSelf: "stretch", display: "flex", borderLeft: "1px solid #294036" },
  requestTechniqueButton: { border: 0, borderRight: "1px solid #294036", padding: "0 10px",
    background: "#101b17", color: "#65e6a0", cursor: "pointer",
  ...
  splitter: { width: 6, flexShrink: 0, cursor: "col-resize", background: "#2a2a34",
    ...
    touchAction: "none" },
  openBtn: { marginTop: 10, width: "100%", padding: "9px 12px", borderRadius: 6,
    border: "1px solid #2d4a3a", background: "#101a15", color: "#59f59a",
    fontSize: 12, fontWeight: 600, textAlign: "left", cursor: "pointer" },
  hideBtn: { marginTop: 10, width: "100%", padding: "8px 12px", borderRadius: 6,
